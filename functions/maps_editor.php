...
if( $_POST["JSN"] != null ){
  $fp=fopen("../rawdata/map_entries/LN_".date("Y_m_d_h_i",time()).".json","w+");
  fwrite($fp,$_POST["JSN"]);
  fclose($fp);

  $fp=fopen("../rawdata/LN_map_data.json","w+");
  fwrite($fp,$_POST["JSN"]);
  fclose($fp);

  $fp=fopen("../rawdata/LN_map.json","w+");
  ...
  <form method="POST">
    ...
    <div class="container">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input id="e_contact" name="e_contact" type="text" class="form-control" placeholder="athens@getfaircoin.net">
        </div>
      </div>
      ...
      <div class="form-group row">
        <label for="e_icon" class="col-sm-2 col-form-label">Map Icon ( URL )</label>
        <div class="col-sm-10">
          <input id="e_icon" name="e_icon" type="text" class="form-control" placeholder="https://upload.wikimedia.org/wikipedia/commons/5/5c/Flag_of_Greece.svg">
        </div>
      </div>
      ...
      <div class="form-group row">
        <label for="e_participants" class="col-sm-2 col-form-label">Participants</label>
        <div class="col-sm-10">
          <input id="e_participants" name="e_participants" type="text" class="form-control">
        </div>
      </div>
      ...
      <div class="form-group row">
        <label for="e_assembly_notes" class="col-sm-2 col-form-label">Assembly Notes</label>
        <div class="col-sm-10">
          <input id="e_assembly_notes" name="e_assembly_notes" type="text" class="form-control">
        </div>
      </div>
    ...
    function get_entries(load){
      if( load == true ) JSN=json_load("../rawdata/LN_map_data.json");
      var L=[];
      var tags=[];
      JSN.forEach(
        function( v,i ){
      ...
      JSN.forEach(
        function( v,i ){
          if( v.properties.id == entry_id ){
            ...
            JSN[i].properties._storage_options.iconUrl = $("#e_icon").val();
